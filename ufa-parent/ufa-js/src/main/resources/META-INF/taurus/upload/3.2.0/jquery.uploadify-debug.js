define("taurus/upload/3.2.0/swfobject-debug", [], function(require, exports, module) {
...
http://www.opensource.org/licenses/mit-license.php
*/
define("taurus/upload/3.2.0/jquery.uploadify-debug", [ "./swfobject-debug" ], function(require) {
    return function($) {
        ...
        var lang = {
            ...
            queueSizeLimit: function(limit, isRemain) {
                return isRemain ? "上传列队的名额（" + limit + "）所剩不多，请少选几个文件。" : "一次只能同时上传 " + limit + " 个文件。";
            }
        };
        var SWFUpload;
