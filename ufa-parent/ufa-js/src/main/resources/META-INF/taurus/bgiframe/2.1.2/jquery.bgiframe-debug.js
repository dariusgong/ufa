...
define("taurus/bgiframe/2.1.2/jquery.bgiframe-debug", [], function(require) { return function($){

	$.fn.bgiframe = (navigator.appName == 'Microsoft Internet Explorer' && /msie 6\.0/i.test(navigator.userAgent) ? function(s){
		s = $.extend({
