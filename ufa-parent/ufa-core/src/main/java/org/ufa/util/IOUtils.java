...
//	}
	 ...
	 * @throws IOException
	 */
	public static void writeLine(OutputStream os, String[] lines) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static void writeLine(File file, String[] lines) throws IOException
	{
		if( file == null )
	        throw new IOException("File is null.");
		writeLine(new FileOutputStream(file), lines);
    }
    ...
    public static void appendLines(File file, String[] lines) throws IOException
    {
        if( file == null )
            throw new IOException("File is null.");
        writeLine(new FileOutputStream(file, true), lines);
    }
